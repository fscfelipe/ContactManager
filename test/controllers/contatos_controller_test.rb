...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { apelido: @contato.apelido, email: @contato.email, foto: @contato.foto, nascimento: @contato.nascimento, nome: @contato.nome, telefone: @contato.telefone }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { apelido: @contato.apelido, email: @contato.email, foto: @contato.foto, nascimento: @contato.nascimento, nome: @contato.nome, telefone: @contato.telefone }
    assert_redirected_to contato_path(assigns(:contato))
  end
